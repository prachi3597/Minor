...
public class DashboardHire extends AppCompatActivity implements View.OnClickListener {
    ...
    @Override    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sign_out_button:
                mAuth.signOut();
                Intent intent=new Intent(DashboardHire.this, PhoneAuthActivity.class);
